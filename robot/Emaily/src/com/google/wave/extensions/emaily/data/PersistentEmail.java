...
public class PersistentEmail implements Serializable {
   ...
   * TODO(taton) Move this to DataAccess.
   * 
  ...
  /**
   * The ID of the email message. Cannot be a primary key since we update it. May be assigned a
   * temporary ID for outgoing emails, until we receive the real message ID generated by the mail
   * server.
   */
  @Key
  @Persistent
