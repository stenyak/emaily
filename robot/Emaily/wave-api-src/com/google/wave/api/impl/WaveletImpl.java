...
public class WaveletImpl implements Wavelet {
  ...
  public void setTitle(String title) {
    ...
    events.addOperation(new OperationImpl(OperationType.WAVELET_SET_TITLE, getWaveId(),
        getWaveletId(), null, -1, title));
  }
  ...
  public void addParticipant(String participant) {
    events.addOperation(new OperationImpl(OperationType.WAVELET_ADD_PARTICIPANT, getWaveId(),
        getWaveletId(), null, -1, participant));
  ...
  public void setDataDocument(String name, String data) {
    events.addOperation(new OperationImpl(OperationType.WAVELET_DATADOC_SET, getWaveId(),
        getWaveletId(), name, -1, data));
  ...
  public boolean hasDataDocument(String name) {
    return waveletData.getDataDocuments() == null ? false : waveletData.getDataDocuments()
        .containsKey(name);
  }
  ...
  public void setTitle(StyledText styledText) {
    ...
    events.addOperation(new OperationImpl(OperationType.WAVELET_SET_TITLE, getWaveId(),
        getWaveletId(), null, styledText.getStyles().get(0).ordinal(), styledText.getText()));
  }

  @Override
  public void appendDataDocument(String name, String data) {
    events.addOperation(new OperationImpl(OperationType.WAVELET_DATADOC_APPEND, getWaveId(),
        getWaveletId(), name, -1, data));
  ...
  public void removeParticipant(String participant) {
    events.addOperation(new OperationImpl(OperationType.WAVELET_REMOVE_PARTICIPANT, getWaveId(),
        getWaveletId(), null, -1, participant));
  }
  ...
  public Wavelet createWavelet(List<String> participants, String annotationWriteBack) {
    ...
    events.addOperation(new OperationImpl(OperationType.WAVELET_CREATE, this.getWaveId(), this
        .getWaveletId(), annotationWriteBack, -1, waveletData));
